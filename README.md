...
**Github Stats Generator** is a modern, fast, and feature-packed web application designed to help developers create GitHub profile `README.md` cards, badges, and templates effortlessly.
...
### 2. Badges & Icon Library (SkillIcons & Shields)
...
- **Integrated SkillIcons.dev**: Create 1:1 square skill strips with dark/light theme switching.
